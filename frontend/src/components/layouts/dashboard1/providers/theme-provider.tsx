...
const THEME_CONFIG_STORAGE_KEY = "theme"
...
function ThemeConfigProvider({
  ...
  const [theme, setTheme] = React.useState<ThemeType>(() => {
    ...
    const storedTheme = window.localStorage.getItem(THEME_CONFIG_STORAGE_KEY)
    if (!storedTheme) {
      return initialTheme ?? DEFAULT_THEME
    }
  ...
  React.useEffect(() => {
    ...
    window.localStorage.setItem(THEME_CONFIG_STORAGE_KEY, JSON.stringify(theme))
  }, [theme])
...
export function ThemeProvider({
  ...
  return (
    <ThemeProviderContext.Provider {...props} value={value}>
      <ThemeConfigProvider initialTheme={initialThemeConfig}>
        {children}
      </ThemeConfigProvider>
