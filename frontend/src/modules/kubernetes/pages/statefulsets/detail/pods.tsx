...
export default function StatefulSetPodsPage() {
  const { namespace, name } = useOutletContext<StatefulSetOutletContext>();
  const query = useQuery({
    queryKey: [K8S_STATEFULSETS_KEY, namespace, name, "pods"],
    queryFn: () => listStatefulSetPods(namespace, name),
